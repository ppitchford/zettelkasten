...
## Notes
> Fill the ordered steps per build. Surface a step into a weekly note when you intend to work it that week; the calendar marks only the target date, never the steps.

...
The active and planned projects. A project note holds the full task list and the next action; a weekly note surfaces a next action only when you intend to do it that week. Projects carry a status — **planned → active → done**.

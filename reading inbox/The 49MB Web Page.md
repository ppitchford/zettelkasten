...
source: "https://thatshubham.com/blog/news-audit"
author:
published: 2026-03-11
created: 2026-08-07
---
Research & Analysis Featured In

Harvard's Nieman Lab • Daring Fireball • Techmeme • AdExchanger • Pluralistic • JavaScript Weekly • Hacker News
...
![Sample of nytimes network tab](https://thatshubham.com/img/network.webp)
...
![network tab of a typical news website](https://thatshubham.com/img/track.webp)

Common story across many offenders

A relentless heartbeat of surveillance.
...
![NYT and Verge GDPR modals](https://thatshubham.com/img/gdpr.webp)

Selected GDPR examples

The advantage and disadvantages of these have been discussed in tech circles ever since they launched.
...
![Screenshot of The Economic Times showing overwhelming ads and popups](https://thatshubham.com/img/economictimes.webp)
...
#### 1 The Double Modal Ambush

The user is hit with not one, but two simultaneous Google sign-in prompts. One is a centered custom modal completely obscuring the text, while the standard Google tap modal slides in from the top right. This is a severe violation of serialized onboarding, causing confusion to a first-time user.

![Bottom Modal](https://thatshubham.com/img/economictimes.webp)

Severe Issue

#### 2 Viewport suffocation

Examine the screen real estate. We have a top banner ad, a left skyscraper, a right skyscraper and an inline ad block. The actual article content occupies roughly 15% of the screen real-estate. The publisher has inverted the content-to-chrome ratio.

![Bottom Modal](https://thatshubham.com/img/economictimes.webp)

Laborious non-work

#### 3 Unacceptable Interaction Cost
...
##### Sources & UX Heuristics Violated

- Aesthetic and Minimalist Design - Interfaces should not contain information that is irrelevant or rarely needed  
	[\[NN/g Usability Heuristic #8\]](https://www.nngroup.com/articles/ten-usability-heuristics/)
- Interaction Cost- The double-modal forces high physical interaction cost before value is delivered  
	[\[NN/g Interaction Cost\]](https://www.nngroup.com/articles/interaction-cost-definition/)
- Core Web Vitals (Intrusive Interstitials) - Google's own search guidelines penalize pages where content is not easily accessible due to intrusive pop-ups covering the main content immediately after navigation  
...
Then there is the fat-finger tax. 'X' buttons immediately adjacent to ad hit-boxes is a calculated mathematical risk by ad-ops teams to generate accidental clicks. These close buttons can easily be bigger, especially on mobile screens but they're not. Feature, not bug territory.

![jagran website on mobile](https://thatshubham.com/img/j1.webp)

Hall of fame: Jagran

Highlighted in red boxes - Open in App obstruction, Modal to subscribe, advert and share section.
...
![Screenshot of text.npr.org text-only news site](https://thatshubham.com/img/npr.webp)

text.npr.org

A lightweight text-only version of NPR with no bloat, tracking and modals.
...
I'm Shubham - a full-stack product engineer specializing in web performance and user-centric architecture.  
I fix the business side of engineering. Web performance audits, hostile UX teardowns, and conversion architecture for media companies, startups, SaaS teams and funds that can't afford to keep losing users to a slow page.  
[thatshubham.com/consult](https://thatshubham.com/consult.html "Contact Page") - two audit slots per month. Reach out early.

[Discover](https://thatshubham.com/discover.html) [Detect AI-Images](https://thatshubham.com/detectimage.html) [FediHired](https://fedi.thatshubham.com/)

This page has a transferred Size: 887 kB. Of which images take 479 kB and hosted fonts take 212 kB.
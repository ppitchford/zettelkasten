...
created: 2026-07-24
---
## The Product Operating Model Explained - Itamar Gilad
...
![](https://itamargilad.com/wp-content/uploads/2025/06/Spectrum-of-operating-model-1024x287.jpg)
...
Modern companies care a lot about business performance, but measure and optimize also value-to-customer, user experience, product health, and company health. They separate between outcomes and outputs and try to set goals only for the former. They work off [outcome roadmaps](https://itamargilad.com/outcome-roadmaps/) rather than release roadmaps.
...
Modern companies consider their ideas hypothetical ways to achieve the goals. They’re willing to spend time [evaluating and testing ideas](https://itamargilad.com/the-tool-that-will-help-you-choose-better-product-ideas/) before committing to delivery, and have no qualms about dumping or pivoting the ideas that don’t work.
...
**Operations and Infrastructure** —In traditional companies the infrastructure and operations functions — IT, dev ops, legal, HR, finance, etc — are aiming to minimize costs, reduce risks, and enforce company policy, even at the cost of adding bureaucratic overhead and slowing down innovation.

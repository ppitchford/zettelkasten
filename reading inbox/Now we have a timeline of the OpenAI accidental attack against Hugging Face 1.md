...
- **May 7**: OpenAI starts a new training run for an experimental, unreleased model. (*Did they mean an evaluation run? No, at [10:14](https://m.youtube.com/watch?v=87DyyMV0kCY&t=614s) they clarify “we kick off a new reinforcement learning run to train a next generation frontier model”, and they later mention a “reward signal to judge how well they’re doing”, so this really was about training a new model, not evaluating one that was already trained.)*

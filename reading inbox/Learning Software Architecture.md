...
created: 2026-08-07
---
I was attached to [a bioinformatics lab](https://lp.jetbrains.com/biolabs/) early in my career, so I think I understand what you are talking about, the phenomenon of “scientific code”! My thoughts:

**First** meta observation is that “software design” is something best learned by doing. While I had some formal “design” courses at the University, and I was even “an architect” for our course project, that stuff was mostly make-believe, kindergarteners playing fire-fighters. What really taught me how to do stuff was an accident of my career, where my second real project ([IntelliJ Rust](https://github.com/intellij-rust/intellij-rust)) propelled me to a position of software leadership, and made design my problem. I did make a few mistakes in IJ Rust, but nothing too horrible, and I learned a lot. So that’s good news — software engineering is simple enough that an inquisitive mind can figure it out from first principles (and reading random blog posts).

**Second** meta observation, the bad news: [Conway’s law](https://en.wikipedia.org/wiki/Conway%27s_law) is important. Softwaregenesis repeats the social architecture of the organization producing software. Or, as put eloquently by [neugierig](https://neugierig.org/software/blog/2020/05/ninja.html),
...
Two things you can do here. *One*, at times you get a chance to design or nudge an incentive structure for a project. This happens once in a blue moon, but is very impactful. *This* is the secret sauce behind [TIGER\_STYLE](https://github.com/tigerbeetle/tigerbeetle/blob/0.17.4/docs/TIGER_STYLE.md), not the set of rules per se, but the social context that makes this set of rules a good idea.
...
[Boundaries](https://www.destroyallsoftware.com/talks/boundaries) talk by Gary Bernhardt is all-time favorite. It contains solid object-level advice, and, for me, it triggered the meta inquiry.

[How to Test](https://matklad.github.io/2021/05/31/how-to-test.html) is something I wish I had. I immediately understood the importance of testing, but it took me a long time to grow arrogant enough to admit that most widely-cited testing advice is shamanistic snake-oil, and to conceptualize what actually works.

[∅MQ guide](https://zguide.zeromq.org/docs/chapter6/) and, more generally, [writings by Pieter Hintjens](http://hintjens.com/) introduced me to Conway’s Law thinking. That “feature development” architecture of rust-analyzer? – [optimistic merging](http://hintjens.com/blog:106), applied.

[Reflections on a decade of coding](https://www.scattered-thoughts.net/writing/reflections-on-a-decade-of-coding/) by Jamii is excellent, goes very meta. It is intentionally the first of [my links](https://matklad.github.io/links.html).

[Ted Kaminski](https://www.tedinski.com/archive/) blog is the closest there is to a coherent theory of software development, appropriately framed as a set of notes to a non-existing book!

As for the actual books, [*Software Engineering at Google*](https://abseil.io/resources/swe-book) and Ousterhout’s *The Philosophy of Software Design* are often recommended. They are good. SWE, in particular, helped me with [a couple of important names](https://matklad.github.io/2022/07/04/unit-and-integration-tests.html). But they weren’t ground breaking for me.